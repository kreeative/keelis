...
const ROUTES = ['/', '/crypto', '/crypto/btc', '/carte', '/carte/details', '/epargne', '/convertir', '/envoyer', '/envoyer/operateurs', '/fonds', '/profil', '/profil/donnees', '/notifications', '/entreprise', '/bienvenue', '/crypto/btc/recevoir']
